...
val defaultMoviesUrl = "https://swmanthastorage.blob.core.windows.net/inputmoviesdata/movies.csv"
val defaultRatingsUrl = "adl://swmantha.azuredatalakestore.net/inputdata/ratings.csv"
...
spark.conf.set("dfs.adls.oauth2.client.id", "dac78244-441d-45bf-9c63-6bdb1fdb259e")
spark.conf.set("dfs.adls.oauth2.credential", "SJN5yBbwx3/Y8iqO/18kkIsBkC4sXVgJ0bnVTROqLOE=")
